...
if (process.argv[2] == "--import"){ //package.json da script yazdık. "import" : "node dummy-generator --import" gibi
    //npm run import dedigimizde burası calıscak 
    importAllData();
}
else if (process.argv[2] == "--delete"){
     //npm run delete dedigimizde burası calıscak 
    deleteAllData();
}
